 ...
 */
export class OrgBluezGattDescriptor1<L extends EventListenerSignature<L> = {}> extends LooselyTypedEmitter<
    OrgBluezGattDescriptor1Events & L
> {
    ...
    public getProperty<T extends keyof OrgBluezGattDescriptor1Props>(
        name: T,
    ): Promise<OrgBluezGattDescriptor1Props[T]> {
        return this.propertiesDBusInterface
            .Get(OrgBluezGattDescriptor1.DbusInterfaceName, name)
            .then(unwrapDbusVariant);
    }

    public setProperty<T extends keyof OrgBluezGattDescriptor1Props>(
        name: T,
        value: OrgBluezGattDescriptor1Props[T],
    ): Promise<void> {
        return this.propertiesDBusInterface.Set(
            OrgBluezGattDescriptor1.DbusInterfaceName,
            name,
