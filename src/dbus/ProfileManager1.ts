...
export class OrgBluezProfileManager1 {
    ...
    public static Connect(
        bus: DBus.MessageBus,
        objectPath: string = "/org/bluez",
        xml: string = XMLObjectData,
    ): Promise<OrgBluezProfileManager1> {
    ...
    public RegisterProfile(profile: DBus.ObjectPath, UUID: string, options: { [key: string]: any }): Promise<void> {
        return this.thisDBusInterface.RegisterProfile(
            wrapDbusSignature(profile, "o"),
            wrapDbusSignature(UUID, "s"),
