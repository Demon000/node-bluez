...
import { LooselyTypedEmitter, EventListenerSignature, unwrapDbusSignature } from "../utilts";
 ...
 */
export class OrgFreedesktopDBusObjectManager<
    L extends EventListenerSignature<L> = Record<string, never>,
> extends LooselyTypedEmitter<OrgFreedesktopDBusObjectManagerEvents & L> {
    ...
    ): Promise<OrgFreedesktopDBusObjectManager> {
