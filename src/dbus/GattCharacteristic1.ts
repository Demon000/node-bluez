 ...
 */
export class OrgBluezGattCharacteristic1<L extends EventListenerSignature<L> = {}> extends LooselyTypedEmitter<
    OrgBluezGattCharacteristic1Events & L
> {
    ...
    public static Connect(
        ...
        objectPath: string,
        xml?: string,
    ): Promise<OrgBluezGattCharacteristic1> {
    ...
    public getProperty<T extends keyof OrgBluezGattCharacteristic1Props>(
        name: T,
    ): Promise<OrgBluezGattCharacteristic1Props[T]> {
        return this.propertiesDBusInterface
            .Get(OrgBluezGattCharacteristic1.DbusInterfaceName, name)
            .then(unwrapDbusVariant);
    }

    public setProperty<T extends keyof OrgBluezGattCharacteristic1Props>(
        name: T,
        value: OrgBluezGattCharacteristic1Props[T],
    ): Promise<void> {
        return this.propertiesDBusInterface.Set(
            OrgBluezGattCharacteristic1.DbusInterfaceName,
            name,
    ...
    public AcquireNotify(options: { [key: string]: any }): Promise<any> {
        return this.thisDBusInterface
            .AcquireNotify(wrapDbusSignature(options, "a{sv}"))
            .then(unwrapDbusSignature("hq"));
    }
