 ...
 */
export class OrgBluezDevice1<L extends EventListenerSignature<L> = Record<string, never>> extends LooselyTypedEmitter<
    OrgBluezDevice1Events & L
> {
    ...
    public AddressType(): Promise<string> {
        return this.propertiesDBusInterface
            .Get(OrgBluezDevice1.DbusInterfaceName, "AddressType")
    ...
    public Alias(value?: string): Promise<any> {
        if (value !== undefined) {
            return this.propertiesDBusInterface.Set(
                OrgBluezDevice1.DbusInterfaceName,
                "Alias",
    ...
    public Appearance(): Promise<number> {
        return this.propertiesDBusInterface
            .Get(OrgBluezDevice1.DbusInterfaceName, "Appearance")
            .then(unwrapDbusVariant);
    }
    ...
    public Trusted(value?: boolean): Promise<any> {
        if (value !== undefined) {
            ...
            return this.propertiesDBusInterface
                .Get(OrgBluezDevice1.DbusInterfaceName, "Trusted")
                .then(unwrapDbusVariant);
        }
    }
    ...
    public Blocked(value?: boolean): Promise<any> {
        if (value !== undefined) {
            ...
            return this.propertiesDBusInterface
                .Get(OrgBluezDevice1.DbusInterfaceName, "Blocked")
                .then(unwrapDbusVariant);
        }
    }
    ...
    public LegacyPairing(): Promise<boolean> {
        return this.propertiesDBusInterface
            .Get(OrgBluezDevice1.DbusInterfaceName, "LegacyPairing")
            .then(unwrapDbusVariant);
    }
    ...
    public ManufacturerData(): Promise<{ [key: number]: any }> {
        return this.propertiesDBusInterface
            .Get(OrgBluezDevice1.DbusInterfaceName, "ManufacturerData")
            .then(unwrapDbusVariant);
    }
    ...
    public ServiceData(): Promise<{ [key: string]: any }> {
        return this.propertiesDBusInterface
            .Get(OrgBluezDevice1.DbusInterfaceName, "ServiceData")
            .then(unwrapDbusVariant);
    }
    ...
    public ServicesResolved(): Promise<boolean> {
        return this.propertiesDBusInterface
            .Get(OrgBluezDevice1.DbusInterfaceName, "ServicesResolved")
            .then(unwrapDbusVariant);
    }
