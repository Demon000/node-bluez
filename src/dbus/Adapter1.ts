 ...
 */
export class OrgBluezAdapter1<L extends EventListenerSignature<L> = Record<string, never>> extends LooselyTypedEmitter<
    OrgBluezAdapter1Events & L
> {
    ...
    public AddressType(): Promise<string> {
        return this.propertiesDBusInterface
            .Get(OrgBluezAdapter1.DbusInterfaceName, "AddressType")
    ...
    public Alias(value?: string): Promise<any> {
        if (value !== undefined) {
            return this.propertiesDBusInterface.Set(
                OrgBluezAdapter1.DbusInterfaceName,
                "Alias",
                wrapDbusVariant(value, "s"),
            );
        } else {
            return this.propertiesDBusInterface
                .Get(OrgBluezAdapter1.DbusInterfaceName, "Alias")
                .then(unwrapDbusVariant);
        }
    }
    ...
    public Powered(value?: boolean): Promise<any> {
        if (value !== undefined) {
            return this.propertiesDBusInterface.Set(
                OrgBluezAdapter1.DbusInterfaceName,
                "Powered",
                wrapDbusVariant(value, "b"),
            );
        } else {
            return this.propertiesDBusInterface
                .Get(OrgBluezAdapter1.DbusInterfaceName, "Powered")
                .then(unwrapDbusVariant);
        }
    }
    ...
    public Discoverable(value?: boolean): Promise<any> {
        if (value !== undefined) {
            ...
            return this.propertiesDBusInterface
                .Get(OrgBluezAdapter1.DbusInterfaceName, "Discoverable")
                .then(unwrapDbusVariant);
        }
    }
    ...
    public DiscoverableTimeout(value?: number): Promise<any> {
        if (value !== undefined) {
            return this.propertiesDBusInterface.Set(
                OrgBluezAdapter1.DbusInterfaceName,
                "DiscoverableTimeout",
                wrapDbusVariant(value, "u"),
            );
        } else {
            return this.propertiesDBusInterface
                .Get(OrgBluezAdapter1.DbusInterfaceName, "DiscoverableTimeout")
                .then(unwrapDbusVariant);
        }
    }
    ...
    public Pairable(value?: boolean): Promise<any> {
        if (value !== undefined) {
            ...
            return this.propertiesDBusInterface
                .Get(OrgBluezAdapter1.DbusInterfaceName, "Pairable")
                .then(unwrapDbusVariant);
        }
    }
    ...
    public PairableTimeout(value?: number): Promise<any> {
        if (value !== undefined) {
            ...
            return this.propertiesDBusInterface
                .Get(OrgBluezAdapter1.DbusInterfaceName, "PairableTimeout")
                .then(unwrapDbusVariant);
        }
    }
    ...
    public Discovering(): Promise<boolean> {
        return this.propertiesDBusInterface
            .Get(OrgBluezAdapter1.DbusInterfaceName, "Discovering")
            .then(unwrapDbusVariant);
    }
